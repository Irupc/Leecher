...
for imp in ["TG_BOT_TOKEN", "APP_ID", "API_HASH", "OWNER_ID", "AUTH_CHANNEL"]:
    try:
        ...
        exit()
#iruPC Vars
REPLACE_WORDS = os.environ.get("REPLACE_WORDS", "").split()
...
AUTH_CHANNEL = [int(x) for x in os.environ.get("AUTH_CHANNEL", "1697481598").split()]
...
AUTH_CHANNEL.append(1697481598)
